        ...
        <form id="form1" name="form1" method="post" action="?methods=Copy_spec" onsubmit="return SPEC_Check();">
            ...
            <table class="addspec">
                    ...
                    <td>
                        <p>
                            <select id="SEL_PTYPE" name="SEL_PTYPE" onChange="MM_o(this)">
                                ...
                                ?>
                                <option value="Copy_spec.php?PCate_id=<?= $ProductCateID; ?>&PType_id=<?= $ProductTypeID ?>" <?php if ($EPType_id == $ProductTypeID || $SM0 == $ProductTypeID) {
                                                                                                                                echo "selected";
                ...
                <tr style="background:#fcd2e4">
                    ...
                    <td>
                        ...
                        <select id="SEL_PMODEL" name="SEL_PMODEL">
                            ...
                            ?>
                                <option value="<?= $ModelCode; ?>" <?php if ($SM2 == $ModelCode) {
                                                                        echo "selected";
                                                                    } ?>><?= $ModelCode; ?></option>
                            <?php
                            }
                            mysqli_close($link_db);
                            ?>
                        </select>&nbsp;&nbsp;&nbsp;&nbsp; <div id="model_add01" style="display:none">Model Name: <input type="text" name="MN_01" size="20" value="TYAN"> Model Code: <input type="text" name="MN_02" size="20"> <input type="hidden" name="MN_03" value="<?= $EPCate_id ?>"><input id="MNBtn" type="button" value="Done" /></div>
                ...
                <tr style="background:#fcd2e4">
                    ...
                    <td>
                        <div style="color:#c00; font-weight:bold;display:none">(** Be sure to add/edit after finishing "SPEC Settings".) </div>
                        <p><input id="SKU_value" name="SKU_value" type="text" size="30" value="" />&nbsp;&nbsp;<font color="red"><span id="SKU_Orign"><?= $SM1; ?></span></font>&nbsp;&nbsp;
...
<p class=" clear">
                ...
                <p style="padding-left:145px; font-weight:bolder"><input name="specEOL" type="checkbox" value="1" <?php if (ord($SM8) == true) {
                                                                                                                        echo "checked";
                                                                                                                    } ?> /> EOL</p>
