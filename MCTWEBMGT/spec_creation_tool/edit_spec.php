  ...
  $("#B_name02").click(function() {
    ...
    if(MN!=""){
     ...
     $.ajax({
      ...
      url: url,
      dataType: "html",
      data: {MN, MID, S_model, skuvalue, PCateID},
...
?>
<option value="edit_spec.php?p_id=<?=$p_SKU?>&PCate_id=<?=$ProductCateID?>&PType_id=<?=$ProductTypeID?>" <?php if($EPType_id==$ProductTypeID || $SM0==$ProductTypeID){ echo "selected"; }?> ><?=$ProductCateName?></option>
<?php
mysqli_close($link_db);
?>
...
<input type="hidden" name="PT1" value="<?=$EPType_id;?>">&nbsp;
  ...
  <tr style="background:#fcd2e4">
    ...
    <td>
      ...
      <div id="brand_add01" style="display:none">Brand Name: 
        ...
        &nbsp;&nbsp;<input id="B_name02"  type="button" value="OK"></div>
    </td>
  </tr>
  ...
  <tr style="background:#fcd2e4">
    ...
    ?>
    <option value="<?=$ModelCode;?>" <?php //if($SM2==$ModelCode) { echo "selected"; } ?><?php /*if($SM1==$SKU) { echo "selected"; } else*/if($SM2==$ModelCode) {echo "selected";} ?>><?=$ModelCode;?></option>
    <?php
    }
    mysqli_close($link_db);
    ?>
    </select>&nbsp;&nbsp;&nbsp;&nbsp; <div id="model_add01" style="display:none">Model Code: <input type="text" name="MN_02" size="20"> <input type="hidden" name="MN_03" value="<?=$EPCate_id?>"><input id="MNBtn" type="button" value="Done" /></div><div id="Model_MGT"></div><div id="Model_error"></div>
    ...
    <td>
	<div style="color:#c00; font-weight:bold">(** Be sure to add/edit after finishing "SPEC Settings".) </div>
	<p><input id="SKU_value" name="SKU_value" type="text" size="30" value="<?=$SM1;?>" />&nbsp;&nbsp;<div id="divAccount"></div><div id="SKU_error"></div></p>
...
$SPECType_numAll="";$SPECType_num="";$ParentSpec_va_all_Sub="";$ParentSpec_va_all_Thr="";$ParentSpec_va_all_ThrChk="";
...
<h4>Exp. Slots -> PCIx:</h4>            
            ...
            mysqli_close($link_db);
            ?>
            </select>&nbsp;<!--<font color=red><?=$PMX7;?></font>--> <div id="PMT_Show06" style="display:none"><input type="text" id="PMS_06" name="PMS_06" size="20" value=""><br />Tooltips :<input id="PMS_06U" name="PMS_06U" type="text" size="20" value=""  /><input type="button" value="Add New" onclick="Add_Matrvalue(6,<?=$p_SKU;?>,<?=$EPType_id;?>);"></div>
</div>
...
<h4>Exp. Slots -> PCI:</h4> 
            ...
            mysqli_close($link_db);
            ?>
            </select>&nbsp;<!--<font color=red><?=$PMX8;?></font>--> <div id="PMT_Show07" style="display:none"><input type="text" id="PMS_07" name="PMS_07" size="20" value=""><br />Tooltips :<input id="PMS_07U" name="PMS_07U" type="text" size="20" value=""  /><input type="button" value="Add New" onclick="Add_Matrvalue(7,<?=$p_SKU;?>,<?=$EPType_id;?>);"></div>
</div>
...
<h4>Memory -> Max.:</h4> 
           <select id="SEL_PMT009" name="SEL_PMT009">
            ...
            mysqli_close($link_db);
            ?>
            </select>&nbsp;<!--<font color=red><?=$PMX10;?></font>--> <div id="PMT_Show09" style="display:none"><input type="text" id="PMS_09" name="PMS_09" size="20" value=""><br />Tooltips :<input id="PMS_09U" name="PMS_09U" type="text" size="20" value=""  /><input type="button" value="Add New" onclick="Add_Matrvalue(9,<?=$p_SKU;?>,<?=$EPType_id;?>);"></div>
</div>
...
<h4>Integrated Features -> Audio (A):</h4> 
            ...
            mysqli_close($link_db);
            ?>
            </select>&nbsp;<!--<font color=red><?=$PMX12;?></font>--> <div id="PMT_Show11" style="display:none"><input type="text" id="PMS_11" name="PMS_11" size="20" value=""><br />Tooltips :<input id="PMS_11U" name="PMS_11U" type="text" size="20" value=""  /><input type="button" value="Add New" onclick="Add_Matrvalue(11,<?=$p_SKU;?>,<?=$EPType_id;?>);"></div>
</div>
...
<h4>Integrated Features -> Video (G):</h4> 
            ...
            mysqli_close($link_db);
            ?>
            </select>&nbsp;<!--<font color=red><?=$PMX13;?></font>--> <div id="PMT_Show12" style="display:none"><input type="text" id="PMS_12" name="PMS_12" size="20" value=""><br />Tooltips :<input id="PMS_12U" name="PMS_12U" type="text" size="20" value=""  /><input type="button" value="Add New" onclick="Add_Matrvalue(12,<?=$p_SKU;?>,<?=$EPType_id;?>);"></div>
</div>
...
<h4>Integrated Features -> LAN (N):</h4> 
            ...
            mysqli_close($link_db);
            ?>
            </select>&nbsp;<!--<font color=red><?=$PMX14;?></font>--> <div id="PMT_Show13" style="display:none"><input type="text" id="PMS_13" name="PMS_13" size="20" value=""><br />Tooltips :<input id="PMS_13U" name="PMS_13U" type="text" size="20" value=""  /><input type="button" value="Add New" onclick="Add_Matrvalue(13,<?=$p_SKU;?>,<?=$EPType_id;?>);"></div>
</div>
...
<h4>Integrated Features -> RAID (R):</h4> 
            ...
            mysqli_close($link_db);
            ?>
            </select>&nbsp;<!--<font color=red><?=$PMX15;?></font>--> <div id="PMT_Show14" style="display:none"><input type="text" id="PMS_14" name="PMS_14" size="20" value=""><br />Tooltips :<input id="PMS_14U" name="PMS_14U" type="text" size="20" value=""  /><input type="button" value="Add New" onclick="Add_Matrvalue(14,<?=$p_SKU;?>,<?=$EPType_id;?>);"></div>
</div>
...
<h4>RoHS (Type):</h4> 
            ...
            mysqli_close($link_db);
            ?>
            </select>&nbsp;<!--<font color=red><?=$PMX17;?></font>--> <div id="PMT_Show16" style="display:none"><input type="text" id="PMS_16" name="PMS_16" size="20" value=""><br />Tooltips :<input id="PMS_16U" name="PMS_16U" type="text" size="20" value=""  /><input type="button" value="Add New" onclick="Add_Matrvalue(16,<?=$p_SKU;?>,<?=$EPType_id;?>);"></div>
</div>
...
<h4>Dim. (inch) -> H:</h4>
            ...
            mysqli_close($link_db);
            ?>
            </select>&nbsp;<!--<font color=red><?=$PMX4;?></font>--> <div id="PMT_Show03" style="display:none"><input type="text" id="PMS_03" name="PMS_03" size="20" value=""><br />Tooltips :<input id="PMS_03U" name="PMS_03U" type="text" size="20" value=""  /><input type="button" value="Add New" onclick="Add_Matrvalue(3,<?=$p_SKU;?>,<?=$EPType_id;?>);"></div>
</div>
...
<h4>Dim. (inch) -> W:</h4>
            ...
            mysqli_close($link_db);
            ?>
            </select>&nbsp;<!--<font color=red><?=$PMX5;?></font>--> <div id="PMT_Show04" style="display:none"><input type="text" id="PMS_04" name="PMS_04" size="20" value=""><br />Tooltips :<input id="PMS_04U" name="PMS_04U" type="text" size="20" value=""  /><input type="button" value="Add New" onclick="Add_Matrvalue(4,<?=$p_SKU;?>,<?=$EPType_id;?>);"></div>
</div>
...
<h4>Dim. (inch) -> D:</h4>
            ...
            mysqli_close($link_db);
            ?>
            </select>&nbsp;<!--<font color=red><?=$PMX6;?></font>--> <div id="PMT_Show05" style="display:none"><input type="text" id="PMS_05" name="PMS_05" size="20" value=""><br />Tooltips :<input id="PMS_05U" name="PMS_05U" type="text" size="20" value=""  /><input type="button" value="Add New" onclick="Add_Matrvalue(5,<?=$p_SKU;?>,<?=$EPType_id;?>);"></div>
</div>
...
$SKUs_Mname01="";$u=0;$str_sm1="";$str_sm2="";$str_sm3="";
$link_db=mysqli_connect($db_host,$db_user,$db_pwd,$dataBase);
mysqli_query($link_db,'SET NAMES utf8');
mysqli_query($link_db, 'SET CHARACTER_SET_CLIENT=utf8');
mysqli_query($link_db, 'SET CHARACTER_SET_RESULTS=utf8');
...
<p style="padding-left:145px; font-weight:bolder"><input name="specEOL" type="checkbox" value="1" <?php if($SM8==true) {echo "checked";} ?>  /> EOL</p>
<p style="padding-left:145px; font-weight:bolder"><input name="specBTO" type="checkbox" value="1" <?php if($SM16==true) {echo "checked";} ?>  /> BTO</p>
<p style="padding-left:145px; font-weight:bolder"><input name="compareBox" type="checkbox" value="1" <?php if($compare==true) {echo "checked";} ?>  /> Enable "COMPARE" button</p>
<p style="padding-left:145px; font-weight:bolder"><input name="quoteBox" type="checkbox" value="1" <?php if($quote==true) {echo "checked";} ?>  /> Enable "REQUEST QUOTE" button</p>
<p class="clear"></p>
<hr class="style-four" /> 
<p class="clear"></p>
