...
<!--<li>4.2 hrs Battery Life w/ 19.53Whr Battery</li>-->
...
<li>Accessory for Cable Cover w/ Docking Station</li>
<li>Adjustable View-angle Docking Station</li>
<li>Accessory for I/O Connectivity</li>
<li>Accessory for Vehicle Mounting VESA 75mm</li>
<li>Accessory for charging battery <br /><br />
<a href="/POS_Cappuccino_Cappuccino" target="mit" /><button type="button" class="btn btn-default">View</button></a>
  ...
  <div class="col-md-6"><a href="/POS_Cappuccino_Cappuccino" target="mit" /><img src="/images/product/POS/Cappuccino-landing.jpg" class="img-responsive" style="margin-top:30%; margin-bottom:10%" /></a></div>
</div>
