...
<div class="course-card p-4">
									...
									<div class="text-black"><span  style="font-size:1.5rem"><a href="/OCPserver_E7278_E7278-S" target="mit" />E7278-S</a></span><br /><span style="font-size:1rem" >(Standard)</span></div>
										...
										<div class="button button-mini button-border button-circle mt-1"><i class="icon-line-plus"></i>Compare</div>
									</div>
</div>
</div>
<div class="col-lg-4">
...
<div class="course-card h-100 p-4">
									<a href="/OCPserver_E8020_E8020-A" target="mit" /><img class="card-img-top" src="/images/product/OCPserver/E8020-advanced-1.gif" alt="Capri E8020-A (Advanced)"></a>
									<div class="card-body center">
...
<div class="col-lg-4">
<div class="course-card h-100 p-4">
									<a href="/OCPserver_E8020_E8020-U" target="mit" /><img class="card-img-top" src="/images/product/OCPserver/E8020-ultra-1.gif" alt="Capri E8020-U (Ultra)"></a>
									<div class="card-body center">
									<h2 class="card-title fw-normal mb-2 center lh2" >Capri</h2>
