			...
			try {
				...
				if (tableHeader instanceof Array && tableHeader.length) {
					...
					for (var i = 0; i < tableHeader.length; i++) {
                        ...
                        //****2021 03/18 add ******
                        var remove='<a id="remove" class="fright pro-remove" title="remove" onclick=reomve_compare('+i+')><i class="icon-line-cross"></i></a>';
                        tRowCell.innerHTML=remove;
                        //****2021 03/18 add end******
                        ...
                        //******** Heardr add value [i][2++] ******
                        if (typeof tableHeader[i][2] !== 'undefined') {
                            tableHeaderCellHTML += '<span class="t-header-devider">' + options.headerRowDevider + '</span>';
                            tableHeaderCellHTML += tableHeader[i][2];
                        }
                        if (typeof tableHeader[i][3] !== 'undefined') {
                            tableHeaderCellHTML += '<span class="t-header-devider">' + options.headerRowDevider + '</span>';
                            tableHeaderCellHTML += tableHeader[i][3];
                        }
                        if (typeof tableHeader[i][4] !== 'undefined') {
                            tableHeaderCellHTML += '<span class="t-header-devider">' + options.headerRowDevider + '</span>';
                            tableHeaderCellHTML += tableHeader[i][4];
                        }
                        //******** Heardr add value [i][2++] END ******
						tableHeaderCellHTML += '</div>';
					...
					if (!!rows[i].rowVal) {
						...
						for (var j = 0; j < rows[i].rowVal.length; j++) {
							...
							for (var k = 0; k < tableHeader.length; k++) {
                                ...
                                //***** 2021.03.24 add value row id********
                                tRowCell.id = 'rowvalue'+k;
                                //***** 2021.03.24 add value row id end********
