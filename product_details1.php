							...
							<div class="product-image position-relative">
								...
								<div class="row clearfix">
									...
									<div class="t-left t-3rem">
										<a href="<?=$Ping_data[1];?>" title="Click to view large images"><i class="icon-zoom-in"></i></a>
									</div>
									<!--end big photo-->
									</div>
						...
						<div class="tabs tabs-bb tabs-bordered clearfix">
							...
							<ul class="tab-nav clearfix">
								...
								if($Memry01_num>0 || $Hdd01_num>0 || $spcpulist_num>0){
									$AVL_display=1;
									echo "<li><a href='#Downloads'>".$SPName01."</a></li>";
								}
								//----- Support / AVL end------
									  	...
									  	if($data_man[0]!=0){
											  ...
											  while($Manu_LData=mysqli_fetch_row($Manu_listcmd)){
											  	...
											  	echo "<div style='color:#898989; font-style: italic; font-size: 0.8rem; display: none;'>Version: ".$Manu_LData[4]."</div>";
													echo "</td>";
													echo "<td><a href=".$Manu_LData[5]." target='blank' /><i class='i-rounded icon-line-eye' style='background-color:#004898; font-size: 2rem;'></i></a></td>";
													echo "</tr>";
												}
												echo "</tbody>";
												echo "</table>";
									  	...
									  	if($data_ds[0]!=0){
											  ...
											  while($Dashe_LData=mysqli_fetch_row($Dashe_listcmd)){
											  	...
											  	echo "<div style='color:#898989; font-style: italic; font-size: 0.8rem; display: none;'>Version: ".$Dashe_LData[4]."</div>";
													echo "</td>";
													echo "<td><a href=".$Dashe_LData[5]." target='blank' /><i class='i-rounded icon-line-eye' style='background-color:#004898; font-size: 2rem;'></i></a></td>";
													echo "</tr>";
												}
												echo "</tbody>";
												echo "</table>";
									  	...
									  	if($data_fru[0]!=0){
											  ...
											  while($Fru_LData=mysqli_fetch_row($Fru_listcmd)){
											  	...
											  	echo "<div style='color:#898989; font-style: italic; font-size: 0.8rem; display: none;'>Version: ".$Fru_LData[4]."</div>";
													echo "</td>";
													echo "<td><a href=".$Fru_LData[5]." target='blank' /><i class='i-rounded icon-line-eye' style='background-color:#004898; font-size: 2rem;'></i></a></td>";
													echo "</tr>";
												}
												echo "</tbody>";
												echo "</table>";
