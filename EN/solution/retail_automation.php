...
<head>
	...
	<meta property="og:title" content="Retail Automation | MiTAC Computing Technology" />
	...
	<!-- Document Title
	============================================= -->
	<title>Retail Automation | MiTAC Computing Technology</title>
					...
					<div class="col-md-7" >
						...
						<div class="row">
							<div class="col-sm-4 center p-1" ><br /><a href="/IndustrialPanelPC_D210-11KS_D210-11KS" /><img src="/EN/solution/images/RA_Kiosk_D210-g.jpg" class="img-fluid" alt="D210" /></a>
								<h4><a href="/IndustrialPanelPC_D210-11KS_D210-11KS" />D210</a></h4></div>
								<div class="col-sm-4 center p-1"><br /><a href="/EmbeddedSystem_E600_E600" /><img src="/EN/solution/images/IT_E600-g.jpg" class="img-fluid" alt="E600" /></a><h4><a href="/EmbeddedSystem_E600_E600" />E600</a></h4></div>
								<div class="col-sm-4 center p-1"><br /><a href="/EN/products/standard-kiosks#K23F" /><img src="/EN/solution/images/Kiosk_K32F-g.jpg" class="img-fluid" alt="Kiosk K32F" /></a><h4><a href="/EN/products/standard-kiosks#K23F" />K32F</h4></a></div>
							</div>
						</div>
						<div class="col-md-5">
							...
							<div class="row">
								<div class="col-sm-6 center p-1"><br /><a href="/IndustrialPanelPC_P150-11KS_P150-11KS" /><img src="/EN/solution/images/RA_ATM_P150-g.jpg" class="img-fluid" alt="P150" /></a>
									...
									<div class="col-sm-6 center p-1"><br /><a href="/IndustrialMotherboard_PH13FEI_PH13FEI"  /><img src="/EN/solution/images/RA_ATM_PH13FEI-g.jpg" class="img-fluid" alt="PH13FEI" /></a>
										<h4><a href="/IndustrialMotherboard_PH13FEI_PH13FEI" target="aa" />PH13FEI</a></h4></div>
									</div>
								</div>
							...
							<div class="row  mt-6">
								...
								<div class="col-md-3">
									...
									<div class="row">
										<div class="col-sm-12 center p-1" ><br /><img src="/EN/solution/images/RA_Hospitality_M6070-g.jpg" class="img-fluid" alt="M6070" /><h4>M6070</h4></div>
									</div>
								</div>
								<div class="col-md-7">
										...
										<div class="col-sm-4 center p-1"><br /><a href="/EmbeddedSystem_MB1-10AP_MB1-10AP" /><img src="/EN/solution/images/RA_VM_MB1-g.jpg" class="img-fluid" alt="MB1" /></a>
											...
											<div class="col-sm-4 center p-1"><br /><a href="/EmbeddedSystem_ME1-118T_ME1-118T" /><img src="/EN/solution/images/RA_AC_ME1-g.jpg" class="img-fluid" alt="ME1" /></a>
												...
												<div class="col-sm-4 center p-1"><br /><a href="/IndustrialMotherboard_PD10AS_PD10AS" /><img src="/EN/solution/images/RA_VM_PD10AS-g.jpg" class="img-fluid" alt="PD10AS" /></a>
													<h4><a href="/IndustrialMotherboard_PD10AS_PD10AS" />PD10AS</a></h4></div>
												</div>
											</div>
											...
											<div class="col-md-6" >
												...
												<div class="row">
													<div class="col-sm-6 center p-1" ><br /><a href="/IndustrialPanelPC_D151-11KS_D151-11KS" /><img src="/EN/solution/images/RA_RPOS_D151.jpg" class="img-fluid" alt="D151" /></a>
														<h4><a href="/IndustrialPanelPC_D151-11KS_D151-11KS" />D151</a></h4></div>
														<div class="col-sm-6 center p-1"><br /><a href="/IndustrialMotherboard_PH12FEI_PH12FEI" /><img src="/EN/solution/images/RA_RPOS_PH12FEI.jpg" class="img-fluid" alt="PH12FEI" /></a>
															<h4><a href="/IndustrialMotherboard_PH12FEI_PH12FEI" />PH12FEI</a></h4></div>
													...
													<div class="col-md-4">
														...
														<div class="row">
															<div class="col-sm-12 center p-1"><br /><a href="/POS_Cappuccino_Cappuccino" /><img src="/EN/solution/images/RA_MPOS_Cappuccino.jpg" class="img-fluid" alt="Cappuccino" /></a>
																<h4><a href="/POS_Cappuccino_Cappuccino" />Cappuccino</a></h4></div>
												...
												<div class="container clearfix mt-3 mb-3">
															...
															<div class="row">
																<div class="col-sm-6 center p-1" ><br /><a href="/IndustrialMotherboard_PH10CMU_PH10CMU" /><img src="/EN/solution/images/FA_MC_PH10CMU-g.jpg" class="img-fluid" alt="PH10CMU" /></a>
																	...
																	<div class="col-sm-6 center p-1"><br /><a href="/EmbeddedSystem_E500_E500" /><img src="/EN/solution/images/RA_TVwall_E500.jpg" class="img-fluid" alt="E500" /></a>
																		<h4><a href="/EmbeddedSystem_E500_E500" />E500</a></h4></div>
													...
													<div class="container-fluid m-0 border-0" style="padding: 80px 0; background:#f8f8f8;">
														<div class="container clearfix">
															...
															<div class="center title-1" ><h2 class="gradient-underline">Solutions: <a href="/POS_Cappuccino_Cappuccino" />Cappuccino Tablet</a> + Docking Station</span></h2></div>
														...
														<div class="container-fluid m-0 border-0" style="padding: 80px 0;">
															<div class="container clearfix">
																...
																<div class="center title-1" ><h2 class="gradient-underline">Solutions: <a href="/EmbeddedSystem_MB1-10AP_MB1-10AP" />MB1-10AP</a> /
																	<a href="/EmbeddedSystem_S310-11KS_S310-11KS" />S310-11KS</a> / <a href="/EmbeddedSystem_S300-10AS_S300-10AS" />S300-10AS</a></h2></div>
																...
																<div class="container-fluid m-0 border-0" style="padding: 80px 0; background:#f8f8f8;">
																	...
																	<div class="container-fluid m-0 border-0" style="padding: 80px 0; ">
																		<div class="container clearfix">
																			...
																			<div class="center title-1" ><h2 class="gradient-underline">Solutions: <a href="/IndustrialPanelPC_D210-11KS_D210-11KS" />D210</a> / <a href="/IndustrialPanelPC_D151-11KS_D151-11KS" />D151</a></h2></div>
																		...
																		<div class="container-fluid m-0 border-0" style="padding: 80px 0; background:#f8f8f8;">
																			<div class="container clearfix">
																				...
																				<div class="center title-1" ><h2 class="gradient-underline">Solutions: <a href="/EmbeddedSystem_E220_E220" />E220</a> / <a href="/EmbeddedSystem_E230_E230" />E230</a></h2></div>
																			...
																			<div class="container-fluid m-0 border-0" style="padding: 80px 0;">
																				<div class="container clearfix">
																					...
																					<div class="center title-1" ><h2 class="gradient-underline">Solutions: <a href="/EN/products/standard-kiosks#K23F" />K32F</a></h2></div>
