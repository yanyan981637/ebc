...
if($_GET['UID']!=""){
  $UID=dowith_sql($_GET['UID']);
  $UID=filter_var($UID);
}


// Title Company Name
$str="SELECT CompanyName, ID, CompanyID, CompanyAddress, Name, Email, Title, CountryCode, Tel, ResponsibleSales, C_DATE, U_DATE FROM partner_user WHERE ID='".$UID."' ";
...
<head>
  ...
  <title>BACKEND - Edit members - Client Accounts Management - MiTAC Partner Zone</title>
                    ...
                    <form class="form row">
                      ...
                      <div class="form-group mb-1 col-sm-12 col-md-2">
                        <div class="form-group">
                          ...
                          <input id="email" name="email" type="" class="form-control" placeholder="" value="<?=$result[5]?>" required disabled >
