...
<head>
	...
	<title>BACKEND - Add/Edit Announcement - Contents Management - MiTAC Partner Zone</title>
				...
				<div class="row breadcrumbs-top d-inline-block">
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">Add Announcement
							</li>
						</ol>
					</div>
				</div>
						...
						<div class="card-content">
							<div class="card-body">
								...
								<div class="form-group">
									...
									<input id="title" type="text" placeholder="" class="form-control" value="" required>
								</div>
								<div class="form-group" style="background:#eee; padding:10px 20px">
									<label><strong>Release to:</strong> </label>
									<div class="form-check" style="margin-bottom:10px">
										<input id="releaseAll" name="release" class="form-check-input" type="radio" value="All" >
										<label class="form-check-label" for="1">All</label>
									</div>
									<div class="form-check">
										<input id="releaseTO" name="release" class="form-check-input" type="radio"value="">
										Please select:
								...
								<div class="form-group" style="background:#eee; padding:10px 20px">
									...
									<div class="form-check" style="margin-bottom:10px">
										<input id="ReleaseNow" name="Schedule" class="form-check-input" type="radio" value="0000-00-00 00:00:00" >
										<label class="form-check-label" for="2">Release Now</label>
									</div>
									<div class="form-check">
										<input id="radioSchedule" name="Schedule" class="form-check-input" type="radio" name="2" id="2" value="" >
									...
									<div class="row">
										<div class="col-6">
											...
											<div class="input-group">
												...
												<input id="scheduleDate" type='text' class="form-control pickadate" placeholder="" />
											</div>
										</div>
										<div class="col-6">
											<div class="form-group">
												...
												<div class="input-group">
													<input id="scheduleTime" type="text" placeholder="23:02:09" class="form-control" value="">
												</div>
											</div>
										</div>
									</div>
								...
								<div class="form-group">
									...
									<textarea  id="message" class="form-control" rows="3" placeholder="(Allow HTML code)"></textarea>
								</div>
								<div class="form-group">
								...
								<br />
								<div class="text-left">
									<button id="Add" type="button" class="btn btn-info mr-1 mb-1"><i class="ft-save"></i> Save</button>
