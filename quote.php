			...
			<div class="container">
				<div class="row col-mb-30">
					...
					<div class="col-lg-6" style="padding:5%">
						...
						<br />
						<!--login button-->
						<div><a href="#modal-register"  data-lightbox="inline"  class="button button-desc button-3d button-rounded button-blue center" style="width:520px">Have an account for Partner Zone?<span>Log in to your Partner Zone Account.</span></a></div>
						<!--end login button-->
						<br />
						<?php
						}
