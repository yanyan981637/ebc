...
if(isset($_REQUEST['act'])!=''){
  ...
  if($d_id01!='' && $d_type01!=''){
	  ...
	  if($d_type01=='Manuals'){
	  $str_del="delete from `sp_manual` where `ID`=".$d_id01;
	  }else if($d_type01=='Datasheets'){
	  $str_del="delete from `sp_datasheet` where `ID`=".$d_id01;
	  }else if($d_type01=='FRU'){
	  $str_del="delete from `sp_fru` where `ID`=".$d_id01;
	  }else{
	  $str_del="delete from `document_list` where `ID`=".$d_id01;
	  }
	  $del_cmd=mysqli_query($link_db,$str_del);
	  echo "<script>alert('Delete The Data!');self.location='doc_mgt.php'</script>";
	  exit();
  }
  }
...
if(trim($_REQUEST['kinds'])=="edit_docmt"){
...
if(isset($_POST['dl_ver'])!=""){
$dl_ver01=trim($_POST['dl_ver']);
}else{
$dl_ver01="";
}
if(isset($_POST['dl_size'])!=""){
$dl_size01=trim($_POST['dl_size']);
}else{
$dl_size01="";
}
if(isset($_POST['dl_desc'])!=""){
$dl_desc01=htmlspecialchars($_POST['dl_desc'], ENT_QUOTES);
}else{
$dl_desc01="";
}
...
if(isset($_POST['Me_vnder'])!=""){
$Me_vnder01=trim($_POST['Me_vnder']);
}else{
$Me_vnder01="";
}
if(isset($_POST['Me_size'])!=""){
$Me_size01=trim($_POST['Me_size']);
}else{
$Me_size01="";
}
if(isset($_POST['Me_type'])!=""){
$Me_type01=trim($_POST['Me_type']);
}else{
$Me_type01="";
}
if(isset($_POST['Me_chip'])!=""){
$Me_chip01=trim($_POST['Me_chip']);
}else{
$Me_chip01="";
}
if(isset($_POST['Me_Vnum'])!=""){
$Me_Vnum01=trim($_POST['Me_Vnum']);
}else{
$Me_Vnum01="";
}
if(isset($_POST['Me_Pnum'])!=""){
$Me_Pnum01=trim($_POST['Me_Pnum']);
}else{
$Me_Pnum01="";
}
if(isset($_POST['Me_AMB'])!=""){
$Me_AMB01=trim($_POST['Me_AMB']);
}else{
$Me_AMB01="";
}
if(isset($_POST['Me_freq'])!=""){
$Me_freq01=trim($_POST['Me_freq']);
}else{
$Me_freq01="";
}
if(isset($_POST['Me_volt'])!=""){
$Me_volt01=trim($_POST['Me_volt']);
}else{
$Me_volt01="";
}
if(isset($_POST['Me_rohs'])!=""){
$Me_rohs01=trim($_POST['Me_rohs']);
}else{
$Me_rohs01="";
}
if(isset($_POST['Me_quaCPU'])!=""){
$Me_quaCPU01=$_POST['Me_quaCPU'];
}else{
$Me_quaCPU01="";
}
if(isset($_POST['SI_vnder'])!=""){
$SI_vnder01=trim($_POST['SI_vnder']);
}else{
$SI_vnder01="";
}
if(isset($_POST['SI_url'])!=""){
...
if($dl_type01==6){
$str_upd="UPDATE `sp_manual` SET `FILENAME`='".$dl_name01."',`FILEDATE`='".$dl_Date01."',`DESCRIPTION`='".$dl_desc01."',`VERSION`='".$dl_ver01."',`PATH`='".$dl_loc01."',`FILESIZE`='".$dl_size01."',`NOTES`='".$dl_note01."',`LANG`='en-US',`MODEL`='".$relProd_val."',`UPDATE_USER`='webmaster',`UPDATE_DATE`='".$now."',`STATUS`='".$status01."' WHERE `ID`=".$m_id01;
}else if($dl_type01==7){
$str_upd="UPDATE `sp_datasheet` SET `FILENAME`='".$dl_name01."',`FILEDATE`='".$dl_Date01."',`DESCRIPTION`='".$dl_desc01."',`VERSION`='".$dl_ver01."',`PATH`='".$dl_loc01."',`FILESIZE`='".$dl_size01."',`NOTES`='".$dl_note01."',`LANG`='en-US',`MODEL`='".$relProd_val."',`UPDATE_USER`='webmaster',`UPDATE_DATE`='".$now."',`STATUS`='".$status01."' WHERE `ID`=".$m_id01;
}else if($dl_type01==9){
$str_upd="UPDATE `sp_fru` SET `FILENAME`='".$dl_name01."',`FILEDATE`='".$dl_Date01."',`DESCRIPTION`='".$dl_desc01."',`VERSION`='".$dl_ver01."',`PATH`='".$dl_loc01."',`FILESIZE`='".$dl_size01."',`NOTES`='".$dl_note01."',`LANG`='en-US',`MODEL`='".$relProd_val."',`UPDATE_USER`='webmaster',`UPDATE_DATE`='".$now."',`STATUS`='".$status01."' WHERE `ID`=".$m_id01;
}
$upd_cmd=mysqli_query($link_db,$str_upd);
echo "<script>alert('Update The Data!');location.href='doc_mgt.php'</script>";
exit();
}


if(trim($_REQUEST['kinds'])=="add_docmt"){
if(isset($_POST['dlA_type'])!=""){
$dlA_type01=trim($_POST['dlA_type']);
}else{
$dlA_type01="";
}
if(isset($_POST['cha_vmodel'])!=""){
$cha_vmodel01=trim($_POST['cha_vmodel']);
}else{
$cha_vmodel01="";
}
if(isset($_POST['subca01A'])!=""){
$subca01A01=trim($_POST['subca01A']);
}else{
$subca01A01="";
}
if(isset($_POST['subca01A_U'])!=""){
$subca01A_U01=trim($_POST['subca01A_U']);
}else{
$subca01A_U01="";
}
if(isset($_POST['subca01A_CHS'])!=""){
$subca01A_CHS01=trim($_POST['subca01A_CHS']);
}else{
$subca01A_CHS01="";
}
if(isset($_POST['subca01A_CHS_vender'])!=""){
$subca01A_CHS_vender01=trim($_POST['subca01A_CHS_vender']);
}else{
$subca01A_CHS_vender01="";
}

if(isset($_POST['dlA_os'])!=''){
...
if(isset($_POST['dlA_ver'])!=''){
$dlA_ver01=trim($_POST['dlA_ver']);
}else{
$dlA_ver01="";
}
if(isset($_POST['dlA_size'])!=''){
$dlA_size01=trim($_POST['dlA_size']);
}else{
$dlA_size01="";
}
if(isset($_POST['dlA_desc'])!=''){
$dlA_desc01=htmlspecialchars($_POST['dlA_desc'], ENT_QUOTES);
}else{
$dlA_desc01="";
}
...
if(isset($_POST['dlA_note'])!=''){
$dlA_note01=trim($_POST['dlA_note']);
}else{
$dlA_note01="";
}
...
if(isset($_POST['MeA_vnder'])!=''){
$MeA_vnder01=trim($_POST['MeA_vnder']);
}else{
$MeA_vnder01="";
}
if(isset($_POST['MeA_size'])!=''){
$MeA_size01=trim($_POST['MeA_size']);
}else{
$MeA_size01="";
}
if(isset($_POST['MeA_type'])!=''){
$MeA_type01=trim($_POST['MeA_type']);
}else{
$MeA_type01="";
}
if(isset($_POST['MeA_chip'])!=''){
$MeA_chip01=trim($_POST['MeA_chip']);
}else{
$MeA_chip01="";
}
if(isset($_POST['MeA_Vnum'])!=''){
$MeA_Vnum01=trim($_POST['MeA_Vnum']);
}else{

}
if(isset($_POST['MeA_Pnum'])!=''){
$MeA_Pnum01=trim($_POST['MeA_Pnum']);
}else{
$MeA_Pnum01="";
}
if(isset($_POST['MeA_AMB'])!=''){
$MeA_AMB01=trim($_POST['MeA_AMB']);
}else{
$MeA_AMB01="";
}
if(isset($_POST['MeA_freq'])!=''){
$MeA_freq01=trim($_POST['MeA_freq']);
}else{
$MeA_freq01="";
}
if(isset($_POST['MeA_volt'])!=''){
$MeA_volt01=trim($_POST['MeA_volt']);
}else{
$MeA_volt01="";
}
if(isset($_POST['MeA_rohs'])!=''){
$MeA_rohs01=trim($_POST['MeA_rohs']);
}else{
$MeA_rohs01="";
}
if(isset($_POST['MeA_quaCPU'])!=''){
$MeA_quaCPU01=trim($_POST['MeA_quaCPU']);
}else{
$MeA_quaCPU01="";
}


if(isset($_POST['SIA_vnder'])!=''){
$SIA_vnder01=trim($_POST['SIA_vnder']);
}else{
$SIA_vnder01="";
}
if(isset($_POST['SIA_url'])!=''){
$SIA_url01=trim($_POST['SIA_url']);
}else{
$SIA_url01="";
}


if(isset($_POST['HDD_vnder'])!=''){
$HDD_vnder01=trim($_POST['HDD_vnder']);
}else{
$HDD_vnder01="";
}
if(isset($_POST['HDD_mname'])!=''){
$HDD_mname01=trim($_POST['HDD_mname']);
}else{
$HDD_mname01="";
}
if(isset($_POST['HDD_size'])!=''){
$HDD_size01=trim($_POST['HDD_size']);
}else{
$HDD_size01="";
}
if(isset($_POST['HDD_type'])!=''){
$HDD_type01=trim($_POST['HDD_type']);
}else{
$HDD_type01="";
}
if(isset($_POST['HDD_capac'])!=''){
$HDD_capac01=trim($_POST['HDD_capac']);
}else{
$HDD_capac01="";
}
if(isset($_POST['HDD_bus'])!=''){
$HDD_bus01=trim($_POST['HDD_bus']);
}else{
$HDD_bus01="";
}
...
if($dlA_type01=="6"){
    $str_MULvalues="select `ID` FROM `sp_manual` order by `ID` desc limit 1";
    $check_MULvalues=mysqli_query($link_db,$str_MULvalues);
    $Max_CValID=mysqli_fetch_row($check_MULvalues);
    $MCount=$Max_CValID[0]+1;
	
	if($dlA_note01!=''){
	$str_inst="INSERT INTO `sp_manual`(`ID`, `FILENAME`, `FILEDATE`, `DESCRIPTION`, `VERSION`, `PATH`, `FILESIZE`, `NOTES`, `LANG`, `MODEL`, `STATUS`) VALUES (".$MCount.",'".$dlA_name01."','".$dlA_Date01."','".$dlA_desc01."','".$dlA_ver01."','".$dlA_loc01."','".$dlA_size01."','".$dlA_note01."','en-US','".$relProd_val."','".$statusA01."')";
	}else{
	$str_inst="INSERT INTO `sp_manual`(`ID`, `FILENAME`, `FILEDATE`, `DESCRIPTION`, `VERSION`, `PATH`, `FILESIZE`, `LANG`, `MODEL`, `STATUS`) VALUES (".$MCount.",'".$dlA_name01."','".$dlA_Date01."','".$dlA_desc01."','".$dlA_ver01."','".$dlA_loc01."','".$dlA_size01."','en-US','".$relProd_val."','".$statusA01."')";
	}
}else if($dlA_type01=="7"){
	$str_DASHvalues="select `ID` FROM `sp_datasheet` order by `ID` desc limit 1";
    $check_DASHvalues=mysqli_query($link_db,$str_DASHvalues);
    $Max_CValID=mysqli_fetch_row($check_DASHvalues);
    $MCount=$Max_CValID[0]+1;
	
	if($dlA_note01!=''){
	$str_inst="INSERT INTO `sp_datasheet`(`ID`, `FILENAME`, `FILEDATE`, `DESCRIPTION`, `VERSION`, `PATH`, `FILESIZE`, `NOTES`, `LANG`, `MODEL`, `STATUS`) VALUES (".$MCount.",'".$dlA_name01."','".$dlA_Date01."','".$dlA_desc01."','".$dlA_ver01."','".$dlA_loc01."','".$dlA_size01."','".$dlA_note01."','en-US','".$relProd_val."','".$statusA01."')";
	}else{
	$str_inst="INSERT INTO `sp_datasheet`(`ID`, `FILENAME`, `FILEDATE`, `DESCRIPTION`, `VERSION`, `PATH`, `FILESIZE`, `LANG`, `MODEL`, `STATUS`) VALUES (".$MCount.",'".$dlA_name01."','".$dlA_Date01."','".$dlA_desc01."','".$dlA_ver01."','".$dlA_loc01."','".$dlA_size01."','en-US','".$relProd_val."','".$statusA01."')";
	}
}else if($dlA_type01=="9"){
    $str_FRUvalues="select `ID` FROM `sp_fru` order by `ID` desc limit 1";
    $check_FRUvalues=mysqli_query($link_db,$str_FRUvalues);
    $Max_CValID=mysqli_fetch_row($check_FRUvalues);
    $MCount=$Max_CValID[0]+1;
	
	if($dlA_note01!=''){
	$str_inst="INSERT INTO `sp_fru`(`ID`, `FILENAME`, `FILEDATE`, `DESCRIPTION`, `VERSION`, `PATH`, `FILESIZE`, `NOTES`, `LANG`, `MODEL`, `STATUS`) VALUES (".$MCount.",'".$dlA_name01."','".$dlA_Date01."','".$dlA_desc01."','".$dlA_ver01."','".$dlA_loc01."','".$dlA_size01."','".$dlA_note01."','en-US','".$relProd_val."','".$statusA01."')";
	}else{
	$str_inst="INSERT INTO `sp_fru`(`ID`, `FILENAME`, `FILEDATE`, `DESCRIPTION`, `VERSION`, `PATH`, `FILESIZE`, `LANG`, `MODEL`, `STATUS`) VALUES (".$MCount.",'".$dlA_name01."','".$dlA_Date01."','".$dlA_desc01."','".$dlA_ver01."','".$dlA_loc01."','".$dlA_size01."','en-US','".$relProd_val."','".$statusA01."')";
	}	
}else if($dlA_type01>"18"){
    $str_Vicpvalues="select `ID` FROM `document_list` order by `ID` desc limit 1";
    $check_Vicpvalues=mysqli_query($link_db,$str_Vicpvalues);
    $Max_CValID=mysqli_fetch_row($check_Vicpvalues);
    $MCount=$Max_CValID[0]+1;
	
	if($dlA_note01!=''){
	$str_inst="INSERT INTO `document_list`(`ID`, `FILENAME`, `FILEDATE`, `DESCRIPTION`, `VERSION`, `PATH`, `FILESIZE`, `NOTES`, `LANG`, `MODEL`, `STATUS`, `TYPE_VAL`, `DTYPE_ID`) VALUES (".$MCount.",'".$dlA_name01."','".$dlA_Date01."','".$dlA_desc01."','".$dlA_ver01."','".$dlA_loc01."','".$dlA_size01."','".$dlA_note01."','en-US','".$relProd_val."','".$statusA01."',1,".$dlA_type01.")";
	}else{
	$str_inst="INSERT INTO `document_list`(`ID`, `FILENAME`, `FILEDATE`, `DESCRIPTION`, `VERSION`, `PATH`, `FILESIZE`, `LANG`, `MODEL`, `STATUS`, `TYPE_VAL`, `DTYPE_ID`) VALUES (".$MCount.",'".$dlA_name01."','".$dlA_Date01."','".$dlA_desc01."','".$dlA_ver01."','".$dlA_loc01."','".$dlA_size01."','en-US','".$relProd_val."','".$statusA01."',1,".$dlA_type01.")";
	}
}
//echo $str_inst;
$inst_cmd=mysqli_query($link_db,$str_inst);
echo "<script>alert('AddNew The Data!');location.href='doc_mgt.php'</script>";
exit();
}
}
...
if(isset($_REQUEST['s_search'])<>''){
  ...
  //$s_search=preg_replace("['\"\$ \r\n\t;<>\*%\?]", '', $_REQUEST['s_search']);
    if($_REQUEST['Sel_DType']<>''){
     ...
     if($sel_dtype==6){
	   $str1="select count(f.FILENAME) from sp_manual f where f.FILENAME like '%".$s_search."%' or f.DESCRIPTION like '%".$s_search."%'";
	 }else if($sel_dtype==7){
	   $str1="select count(g.FILENAME) from sp_datasheet g where g.FILENAME like '%".$s_search."%' or g.DESCRIPTION like '%".$s_search."%'";
	 }else if($sel_dtype==9){
	   $str1="select count(i.FILENAME) from sp_fru i where i.FILENAME like '%".$s_search."%' or i.DESCRIPTION like '%".$s_search."%'";
	 }else if($sel_dtype==0){
	   //$str1="select count(m.FILENAME) from document_list m where m.FILENAME like '%".$s_search."%' or m.DESCRIPTION like '%".$s_search."%'";
	   $str1="select * from (select count(f.FILENAME)+(select count(g.FILENAME) from sp_datasheet g where g.FILENAME like '%".$s_search."%' or g.DESCRIPTION like '%".$s_search."%')+(select count(i.FILENAME) from sp_fru i where i.FILENAME like '%".$s_search."%' or i.DESCRIPTION like '%".$s_search."%') as Tcount FROM sp_manual f where f.FILENAME like '%".$s_search."%' or f.DESCRIPTION like '%".$s_search."%') a";
	 }
    }else{
	   //$str1="select count(*) from `document_list` where (`doc_name` like '%".$s_search."%' or `doc_version` like '%".$s_search."%' or `doc_fsize` like '%".$s_search."%')";
	   $str1="select * from (select count(f.FILENAME)+(select count(g.FILENAME) from sp_datasheet g where g.FILENAME like '%".$s_search."%' or g.DESCRIPTION like '%".$s_search."%')+(select count(i.FILENAME) from sp_fru i where i.FILENAME like '%".$s_search."%' or i.DESCRIPTION like '%".$s_search."%') as Tcount FROM sp_manual f where f.FILENAME like '%".$s_search."%' or f.DESCRIPTION like '%".$s_search."%') a";
	}
  }else{
	...
	if(isset($_REQUEST['Sel_DType'])<>''){
     $sel_dtype=$_REQUEST['Sel_DType'];
     if($sel_dtype==6){
	   $str1="select count(f.FILENAME) from sp_manual f";
	 }else if($sel_dtype==7){
	   $str1="select count(g.FILENAME) from sp_datasheet g";
	 }else if($sel_dtype==9){
	   $str1="select count(i.FILENAME) from sp_fru i";
	 }else if($sel_dtype==0){
	   $str1="SELECT count(f.FILENAME)+(select count(g.FILENAME) from sp_datasheet g)+(select count(i.FILENAME) from sp_fru i) FROM sp_manual f";
	 }
	}else{	 
	   $str1="SELECT count(f.FILENAME)+(select count(g.FILENAME) from sp_datasheet g)+(select count(i.FILENAME) from sp_fru i) FROM sp_manual f";
	}  
...
<title>Website Contents Management - Products Management - Contents: Modules - Document management</title>
...
function HS_setDate(inputObj){
	...
	function MM_PT(selObj){
	  ...
	  if(dl_num==1){
	  $("#tr_1").show();$("#tr_1_01").show();$("#tr_1_02").hide();$("#tr_1_03").show();$("#tr_1_04").show();$("#tr_1_05").show();$("#tr_1_06").show();$("#tr_1_07").show();$("#tr_1_08").show();$("#tr_1_09").show();
	  $("#tr_2").hide();
	  $("#tr_3").hide();
	  $("#tr_4").hide();
	  ...
	  $("#tr_1").show();$("#tr_1_01").hide();$("#tr_1_02").hide();$("#tr_1_03").hide();$("#tr_1_04").show();$("#tr_1_05").show();$("#tr_1_06").show();$("#tr_1_07").show();$("#tr_1_08").show();$("#tr_1_09").show();
	  $("#tr_2").hide();
	  $("#tr_3").hide();
	  $("#tr_4").hide();
	  document.getElementById('download_pannel').style.display='block';
	  ...
	  document.getElementById('dlA_loc').style.display='block';
	  document.getElementById('subca01A').style.display='none';
	  document.getElementById('subca01A_U').style.display='block';
	  document.getElementById('Memory_pannel').style.display='none';
	  document.getElementById('SI_pannel').style.display='none';
	  document.getElementById('HDD_pannel').style.display='none';
	  document.getElementById('os_area').style.display='block';
	  ...
	  $("#tr_1").hide();$("#tr_1_01").hide();$("#tr_1_02").hide();$("#tr_1_03").hide();
	  $("#tr_2").show();
	  $("#tr_3").hide();
	  $("#tr_4").hide();
	  ...
	  document.getElementById('subca01A').style.display='none';
	  document.getElementById('subca01A_U').style.display='none';
	  document.getElementById('Memory_pannel').style.display='block';
	  document.getElementById('SI_pannel').style.display='none';
	  document.getElementById('HDD_pannel').style.display='none';
	  document.getElementById('os_area').style.display='none';
	  document.getElementById('subca01A_CHS').style.display='none';
	  ...
	  $("#tr_1").show();$("#tr_1_01").show();$("#tr_1_02").show();$("#tr_1_03").hide();$("#tr_1_04").hide();$("#tr_1_05").hide();$("#tr_1_06").hide();$("#tr_1_07").hide();$("#tr_1_08").hide();$("#tr_1_09").hide();
	  $("#tr_2").hide();
	  $("#tr_3").hide();
	  $("#tr_4").hide();
	  document.getElementById('download_pannel').style.display='block';
	  document.getElementById('cha_vmodel').style.display='block';
	  document.getElementById('dlA_name').style.display='none';
	  document.getElementById('dlA_Date').style.display='none';
	  document.getElementById('dlA_ver').style.display='none';
	  document.getElementById('dlA_size').style.display='none';
	  ...
	  document.getElementById('SI_pannel').style.display='none';
	  document.getElementById('os_area').style.display='none';
	  document.getElementById('subca01A_CHS').style.display='block';
	  document.getElementById('subca01A_CHS_vender').style.display='block';
	  }else if(dl_num==6){
	  $("#tr_1").show();$("#tr_1_01").hide();$("#tr_1_02").hide();$("#tr_1_03").hide();$("#tr_1_04").show();$("#tr_1_05").show();$("#tr_1_06").show();$("#tr_1_07").show();$("#tr_1_08").show();$("#tr_1_09").show();
	  $("#tr_2").hide();
	  $("#tr_3").hide();
	  ...
	  document.getElementById('subca01A_U').style.display='none';
	  document.getElementById('Memory_pannel').style.display='none';
	  document.getElementById('SI_pannel').style.display='block';
	  document.getElementById('HDD_pannel').style.display='none';
	  document.getElementById('os_area').style.display='none';
	  document.getElementById('subca01A_CHS').style.display='none';
	  document.getElementById('subca01A_CHS_vender').style.display='none';
	  ...
	  document.getElementById('Memory_pannel').style.display='none';
	  document.getElementById('SI_pannel').style.display='none';
	  document.getElementById('HDD_pannel').style.display='block';
	  document.getElementById('os_area').style.display='none';
	  document.getElementById('subca01A_CHS').style.display='none';
	  document.getElementById('subca01A_CHS_vender').style.display='none';
	  }else if(dl_num>18){
	...
	function MM_PTM(selObj){
	  // Manuals, Datasheets, FRU, VideoCompatibility
	  ...
	  $("#tr_1M").show();$("#tr_1_01M").hide();$("#tr_1_02M").hide();$("#tr_1_03M").hide();$("#tr_1_04M").show();$("#tr_1_05M").show();$("#tr_1_06M").show();$("#tr_1_07M").show();$("#tr_1_08M").show();$("#tr_1_09M").show();
	  $("#tr_2M").hide();
	  $("#tr_3M").hide();
	  $("#tr_4M").hide();
	  document.getElementById('download_pannelM').style.display='block';
	  ...
	  document.getElementById('dl_loc').style.display='block';
	  document.getElementById('subca01').style.display='none';
	  document.getElementById('subca01_U').style.display='block';
	  document.getElementById('Memory_pannelM').style.display='none';
	  document.getElementById('SI_pannel').style.display='none';
	  document.getElementById('HDD_pannel').style.display='none';
	  document.getElementById('os_areaM').style.display='block';
	  ...
	  $("#tr_1M").hide();$("#tr_1_01M").hide();$("#tr_1_02M").hide();$("#tr_1_03M").hide();
	  $("#tr_2M").show();
	  $("#tr_3M").hide();
	  $("#tr_4M").hide();
	  ...
	  document.getElementById('subca01').style.display='none';
	  document.getElementById('subca01_U').style.display='none';
	  document.getElementById('Memory_pannelM').style.display='block';
	  document.getElementById('SI_pannel').style.display='none';
	  document.getElementById('HDD_pannel').style.display='none';
	  document.getElementById('os_areaM').style.display='none';
	  document.getElementById('subca01_CHS').style.display='none';
	  ...
	  $("#tr_1M").show();$("#tr_1_01M").show();$("#tr_1_02M").show();$("#tr_1_03M").hide();$("#tr_1_04M").hide();$("#tr_1_05M").hide();$("#tr_1_06M").hide();$("#tr_1_07M").hide();$("#tr_1_08M").hide();$("#tr_1_09M").hide();
	  $("#tr_2M").hide();
	  $("#tr_3M").hide();
	  $("#tr_4M").hide();
	  document.getElementById('download_pannelM').style.display='block';
	  document.getElementById('cha_vmodelM').style.display='block';
	  document.getElementById('dl_name').style.display='none';
	  document.getElementById('dl_Date').style.display='none';
	  document.getElementById('dl_ver').style.display='none';
	  document.getElementById('dl_size').style.display='none';
	  ...
	  document.getElementById('SI_pannel').style.display='none';
	  document.getElementById('os_areaM').style.display='none';
	  document.getElementById('subca01_CHS').style.display='block';
	  document.getElementById('subca01_CHS_vender').style.display='block';
	  }else if(dl_num==6){
	  $("#tr_1M").show();$("#tr_1_01M").hide();$("#tr_1_02M").hide();$("#tr_1_03M").hide();$("#tr_1_04M").show();$("#tr_1_05M").show();$("#tr_1_06M").show();$("#tr_1_07M").show();$("#tr_1_08M").show();$("#tr_1_09M").show();
	  $("#tr_2M").hide();
	  $("#tr_3M").hide();
	  ...
	  document.getElementById('subca01_U').style.display='none';
	  document.getElementById('Memory_pannelM').style.display='none';
	  document.getElementById('SI_pannelM').style.display='block';
	  document.getElementById('HDD_pannel').style.display='none';
	  document.getElementById('os_areaM').style.display='none';
	  document.getElementById('subca01_CHS').style.display='none';
	  document.getElementById('subca01_CHS_vender').style.display='none';
	  ...
	  $("#tr_1M").show();$("#tr_1_01M").hide();$("#tr_1_02M").hide();$("#tr_1_03M").hide();$("#tr_1_04M").show();$("#tr_1_05M").show();$("#tr_1_06M").show();$("#tr_1_07").show();$("#tr_1_08M").show();$("#tr_1_09M").show();
	  $("#tr_2M").hide();
	  $("#tr_3M").hide();
	  $("#tr_4M").hide();
	  document.getElementById('download_pannelM').style.display='block';
	  ...
	  document.getElementById('HDD_pannelM').style.display='block';
	  document.getElementById('os_areaM').style.display='none';
	  document.getElementById('subca01_CHS').style.display='none';
	  document.getElementById('subca01_CHS_vender').style.display='none';
	  }else if(dl_num>18){
...
<div class="clear"></div>
<div id="Search" >
<h2>Contents &nbsp;&gt;&nbsp;  <a href="../modules.php">Modules</a>  &nbsp;&gt;&nbsp; Document management</h2> 
</div>
<div id="content">
<br />
<h3>Documents List:
...
<p>
<form id="form3" name="form3" method="post" action="doc_mgt.php" onsubmit="return false;">
<select id="Sel_DType" name="Sel_DType">
<!--
<option value="doc_mgt.php?sel_dtype=" selected>All Types</option>
<option value="doc_mgt.php?sel_dtype=Drivers">Drivers</option>
<option value="doc_mgt.php?sel_dtype=BIOS">BIOS</option>
<option value="doc_mgt.php?sel_dtype=Memory">Memory</option>
<option value="doc_mgt.php?sel_dtype=Manuals">Manuals</option>
<option value="doc_mgt.php?sel_dtype=Datasheets">Datasheets</option>
<option value="doc_mgt.php?sel_dtype=Video">Video Compatibility</option>
<option value="doc_mgt.php?sel_dtype=IPMI">IPMI/iKVM firmware</option>
-->
<option value="0" selected>All Types</option>
<?php
//$str_dl="SELECT `ID`, `NAME` FROM `c_sp_itemlist` where `ID` in (6,7,9,14)";
$str_dl="SELECT `ID`, `NAME` FROM `c_sp_itemlist` where `TYPE_VAL`='DC'";
...
<table class="list_table">
  <tr>
    <th >*Doc Name</th><th  >*Doc Type <a class="fancybox fancybox.iframe" href="lb_doc_type.php" /><img src="../../images/icon_edit.png" alt="Edit" /></a></th><th  >*File Date</th><th  >Products</th><th>*Status</th><th><div class="button14" style="width:50px;"><a href="#docmt_add" STYLE="text-decoration:none" onClick="show_add();">Add</a></div></th>
  </tr>
  <?php
      ...
      $start_num=$read_num*($page-1); 
		...
		//$s_search=preg_replace("['\"\$ \r\n\t;<>\*%\?]", '', $_REQUEST['s_search']);
		  ...
		  $sel_dtype=$_REQUEST['Sel_DType'];
		  if($sel_dtype==6){
		  $str="select f.ID, f.FILENAME, 'Manuals' as DL_Type, f.FILEDATE, f.MODEL, f.STATUS from sp_manual f where f.FILENAME like '%".$s_search."%' or f.DESCRIPTION like '%".$s_search."%' ORDER BY f.UPDATE_DATE desc limit $start_num,$read_num;";
		  }else if($sel_dtype==7){
		  $str="select g.ID, g.FILENAME, 'Datasheets' as DL_Type, g.FILEDATE, g.MODEL, g.STATUS from sp_datasheet g where g.FILENAME like '%".$s_search."%' or g.DESCRIPTION like '%".$s_search."%' ORDER BY g.UPDATE_DATE desc limit $start_num,$read_num;";
		  }else if($sel_dtype==9){
		  $str="select i.ID, FILENAME, 'FRU' as DL_Type, i.FILEDATE, i.MODEL, i.STATUS from sp_fru i where i.FILENAME like '%".$s_search."%' or i.DESCRIPTION like '%".$s_search."%' ORDER BY i.UPDATE_DATE desc limit $start_num,$read_num;";
		  }else if($sel_dtype==0){
		  //$str="select m.ID, m.FILENAME, (SELECT `NAME` FROM `c_sp_itemlist` where `ID`=".$sel_dtype.") as DL_Type, m.FILEDATE, m.MODEL, m.STATUS from `document_list` m where m.FILENAME like '%".$s_search."%' or m.DESCRIPTION like '%".$s_search."%' ORDER BY m.UPDATE_DATE desc limit $start_num,$read_num;";
		  $str="SELECT a.ID, a.FILENAME, a.DL_Type, a.FILEDATE, a.MODEL, a.STATUS, a.UPDATE_DATE from (SELECT ID, FILENAME, 'Manuals' as DL_Type, FILEDATE, MODEL, STATUS, UPDATE_DATE FROM sp_manual UNION ALL SELECT ID, FILENAME, 'Datasheets' as DL_Type, FILEDATE, MODEL, STATUS, UPDATE_DATE FROM sp_datasheet UNION ALL SELECT ID, FILENAME, 'FRU' as DL_Type, FILEDATE, MODEL, STATUS, UPDATE_DATE FROM sp_fru) a where a.FILENAME like '%".$s_search."%' ORDER BY a.FILEDATE DESC limit $start_num,$read_num;";
		  }
		  }else{
		  $str="SELECT a.ID, a.FILENAME, a.DL_Type, a.FILEDATE, a.MODEL, a.STATUS, a.UPDATE_DATE from (SELECT ID, FILENAME, 'Manuals' as DL_Type, FILEDATE, MODEL, STATUS, UPDATE_DATE FROM sp_manual UNION ALL SELECT ID, FILENAME, 'Datasheets' as DL_Type, FILEDATE, MODEL, STATUS, UPDATE_DATE FROM sp_datasheet UNION ALL SELECT ID, FILENAME, 'FRU' as DL_Type, FILEDATE, MODEL, STATUS, UPDATE_DATE FROM sp_fru) a where a.FILENAME like '%".$s_search."%' ORDER BY a.FILEDATE DESC limit $start_num,$read_num;";
          }
		  ...
		  $sel_dtype=$_REQUEST['Sel_DType'];
		  if($sel_dtype==6){
		   $str="select f.ID, f.FILENAME, 'Manuals' as DL_Type, f.FILEDATE, f.MODEL, f.STATUS from sp_manual f ORDER BY f.UPDATE_DATE DESC limit $start_num,$read_num;";
		  }else if($sel_dtype==7){
		   $str="select g.ID, g.FILENAME, 'Datasheets' as DL_Type, g.FILEDATE, g.MODEL, g.STATUS from sp_datasheet g ORDER BY g.UPDATE_DATE DESC limit $start_num,$read_num;";
		  }else if($sel_dtype==9){
		   $str="select i.ID, FILENAME, 'FRU' as DL_Type, i.FILEDATE, i.MODEL, i.STATUS from sp_fru i ORDER BY i.UPDATE_DATE DESC limit $start_num,$read_num;";
		  }else if($sel_dtype==0){
		   $str="SELECT a.ID, a.FILENAME, a.DL_Type, a.FILEDATE, a.MODEL, a.STATUS, a.UPDATE_DATE from (SELECT ID, FILENAME, 'Manuals' as DL_Type, FILEDATE, MODEL, STATUS, UPDATE_DATE FROM sp_manual UNION ALL SELECT ID, FILENAME, 'Datasheets' as DL_Type, FILEDATE, MODEL, STATUS, UPDATE_DATE FROM sp_datasheet UNION ALL SELECT ID, FILENAME, 'FRU' as DL_Type, FILEDATE, MODEL, STATUS, UPDATE_DATE FROM sp_fru) a ORDER BY a.FILEDATE DESC limit $start_num,$read_num;";
		  }
		  }else{		  
		   $str="SELECT a.ID, a.FILENAME, a.DL_Type, a.FILEDATE, a.MODEL, a.STATUS, a.UPDATE_DATE from (SELECT ID, FILENAME, 'Manuals' as DL_Type, FILEDATE, MODEL, STATUS, UPDATE_DATE FROM sp_manual UNION ALL SELECT ID, FILENAME, 'Datasheets' as DL_Type, FILEDATE, MODEL, STATUS, UPDATE_DATE FROM sp_datasheet UNION ALL SELECT ID, FILENAME, 'FRU' as DL_Type, FILEDATE, MODEL, STATUS, UPDATE_DATE FROM sp_fru) a ORDER BY a.FILEDATE DESC limit $start_num,$read_num;";
		  }
  ...
  <tr>
	...
	?></td><td><?=$MODEL;?></td><td><?php if($STATUS==1){ echo "Online"; }else if($STATUS==0){ echo "Offline"; } ?></td><td ><a id="dw_edit" href="?mid=<?=$ID;?>&d_type=<?=$DL_Type;?> #docmt_edit">Edit</a>&nbsp;&nbsp;<a href="?act=del&d_id=<?=$ID;?>&d_type=<?=$DL_Type;?>" onclick="return confirm('Are you sure you want to delete this item?');">Del</a></td>
  </tr> 
  <?php
	  }
  ?>
...
<p class="clear">&nbsp;</p>
<!--Click Edit and add -->
<div id="docmt_add" class="subsettings" style="display:none">
<form id="form1" name="form1" method="post" action="?kinds=add_docmt" onsubmit="return Final_Check();">							
<h1>Add a Document file</h1>
...
<?php
//$str_dltpA="SELECT `ID`, `NAME` FROM `c_sp_itemlist` where `ID` in (6,7,9,14)";
$str_dltpA="SELECT `ID`, `NAME` FROM `c_sp_itemlist` where `TYPE_VAL`='DC'";
...
<p style="color:#0F0">
- 若選擇的 Document type ，在 設定時，有check Subcategory，會出現下面 Subcategory 的選單。若有 check OS ，則會出現下面的 OS list 。 
</p>
</td>
</tr>
<!--設定 Subcategory-->
...
<tr id="tr_1_05">
<th>File Date:  </th>
<td><input id="dlA_Date" name="dlA_Date" type="text" size="10" value="" onfocus="HS_setDate(this)" style="display:none" /></td>
</tr>
<tr id="tr_1_06">
<th>Version:  </th>
...
$d_type01=$_REQUEST['d_type'];
  ...
  if(trim($d_type01)=="Manuals"){
  $str_m="Select `ID`, `FILENAME`, `FILEDATE`, `DESCRIPTION`, `VERSION`, `PATH`, `FILESIZE`, `NOTES`, `LANG`, `MODEL`, `STATUS` from `sp_manual` where `ID`=".$mid;
  ...
  $model01=$m_data[9];  
  $status01=$m_data[10];
  }else if(trim($d_type01)=="Datasheets"){
  $str_m="Select `ID`, `FILENAME`, `FILEDATE`, `DESCRIPTION`, `VERSION`, `PATH`, `FILESIZE`, `NOTES`, `LANG`, `MODEL`, `STATUS` from `sp_datasheet` where `ID`=".$mid;
  $m_result=mysqli_query($link_db,$str_m);
  $m_data=mysqli_fetch_row($m_result);
  $id01=$m_data[0];
  $filename01=$m_data[1];
  ...
  $model01=$m_data[9];  
  $status01=$m_data[10];
  }else if(trim($d_type01)=="FRU"){
  $str_m="Select `ID`, `FILENAME`, `FILEDATE`, `DESCRIPTION`, `VERSION`, `PATH`, `FILESIZE`, `NOTES`, `LANG`, `MODEL`, `STATUS` from `sp_fru` where `ID`=".$mid;
  $m_result=mysqli_query($link_db,$str_m);
  $m_data=mysqli_fetch_row($m_result);
  $id01=$m_data[0];
  $filename01=$m_data[1];
  ...
  $model01=$m_data[9];  
  $status01=$m_data[10];
  }else if(trim($d_type01)=="Press Review"){
  $str_m="Select `ID`, `FILENAME`, `FILEDATE`, `VERSION`, `PATH`, `DESCRIPTION`, `LANG`, `MODEL`, `STATUS` from `sp_pressreview` where `ID`=".$mid;
  $m_result=mysqli_query($link_db,$str_m);
  $m_data=mysqli_fetch_row($m_result);
  $id01=$m_data[0];
  $filename01=$m_data[1];
  ...
  $version01=$m_data[3];
  $path01=$m_data[4];
  $description01=$m_data[5];
  $lang01=$m_data[6];
  $model01=$m_data[7];  
  $status01=$m_data[8];
  }else if(trim($d_type01)=="HDD"){
  $str_m="Select `ID`, `VENDER_NAME`, `HDD_SIZE`, `NOTE`, `HDD_TYPE`, `HDD_CAPACITY`, `HDD_BUS`, `LANG`, `MODEL`, `STATUS`, `MODEL_NAME` from `sp_hdd` where `ID`=".$mid;
  $m_result=mysqli_query($link_db,$str_m);
  $m_data=mysqli_fetch_row($m_result);
  $id01=$m_data[0];
  $vender_name01=$m_data[1];
  $hdd_size01=$m_dtaa[2];
  $note01=$m_dtaa[3];
  $hdd_type01=$m_dtaa[4];
  $hdd_capacity01=$m_dtaa[5];
  $hdd_bus01=$m_dtaa[6];
  $lang01=$m_dtaa[7];
  $model01=$m_dtaa[8];
  $status01=$m_dtaa[9];
  }else{
  $str_m="Select `ID`, `FILENAME`, `FILEDATE`, `DESCRIPTION`, `VERSION`, `PATH`, `FILESIZE`, `NOTES`, `LANG`, `MODEL`, `STATUS` from `document_list` where `ID`=".$mid;
  $m_result=mysqli_query($link_db,$str_m);
  $m_data=mysqli_fetch_row($m_result);
  $id01=$m_data[0];
  $filename01=$m_data[1];
...
?>
<div id="docmt_edit" class="subsettings" style="display:none">
<form id="form2" name="form2" method="post" action="?kinds=edit_docmt" enctype="multipart/form-data" onsubmit="return Final_MCheck();">
<input type="hidden" name="m_id" value="<?=$id01;?>">
<h1>Edit a Document file</h1>
...
<?php
//$str_dltp="SELECT `ID`, `NAME` FROM `c_sp_itemlist` where `ID` in (6,7,9,14) and `NAME`='".trim($d_type01)."'";
$str_dltp="SELECT `ID`, `NAME` FROM `c_sp_itemlist` where `TYPE_VAL`='DC' and `NAME`='".trim($d_type01)."'";
...
<tr id="tr_1_05M">
<th>File Date:  </th>
<td><input id="dl_Date" name="dl_Date" type="text" size="10" value="<?=$filedata01;?>" onfocus="HS_setDate(this)" style="display:none" /></td>
</tr>
<tr id="tr_1_06M">
<th>Version:  </th>
...
<tr>
<th>Products:</th>
<td><div class="button14" style="width:60px;" ><a class="fancybox fancybox.iframe" href="../elb_dcmould_mo.php?cid=<?=$id01;?>&d_type=<?=$d_type01;?>" style="color:#ffffff">Edit</a></div>
 <!--列出被勾選的Products-->
