...
$str_New="select `ID` from `c_sp_memory_modulevender` order by `ID` desc limit 1";
...
if($MV_str01==''){
   ...
   $str_chk="SELECT `ID` FROM `c_sp_memory_modulevender` where `MODULEVENDER`='".$MV_str01."' and `URL`='".$MV_str02."' and `STATUS`=1";
		   //SELECT `ID`, `MODULEVENDER`, `ICON`, `URL`, `UPDATE_USER`, `UPDATE_DATE`, `STATUS` FROM `c_sp_memory_modulevender`
   ...
   if(empty($chk_record)):   
	  ...
	  if($MyFile!=''){
	  $str_val="insert into `c_sp_memory_modulevender` (`ID`, `MODULEVENDER`, `ICON`, `URL`, `STATUS`) values (".$MCount.",'".$MV_str01."','$url$MyFile','".$MV_str02."','1')";
	  }else{
	  $str_val="insert into `c_sp_memory_modulevender` (`ID`, `MODULEVENDER`, `URL`, `STATUS`) values (".$MCount.",'".$MV_str01."','".$MV_str02."','1')";
	  }
