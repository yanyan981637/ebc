...
echo "    parent.window.opener.document.forms['form1'].relProd_val.value = '".$mm_modellist.$mb_modellist.$nh_modellist.$as_modellist.$mm_skulist.$mb_skulist.$chs_skulist.$nh_skulist.$as_skulist."'";
