...
//$select=mysqli_select_db($dataBase);
	...
	if($cid!=''){
	  if($slang!=''){
	  $str_prod="SELECT `Product_SContents_Auto_ID`, `CategoryModuID`, `ProductTypeID`, `SKU`, `MODELCODE`, `STATUS`, `slang`, `Product_Info`, `ProductFile`, `ProductBFile`, `ProductSFile`, `Product_Icons`, `Product_dsc`, `Relate_enable`, `Relate_Prod`, `Compat_enable`, `Compat_Prod`, `crea_d`, `crea_u`, `upd_d`, `upd_u`, `Product_Icons_b` FROM `contents_product_skus` where Product_SContents_Auto_ID=".$cid." and `slang`='".$slang."'";
	  }else{
	  $str_prod="SELECT `Product_SContents_Auto_ID`, `CategoryModuID`, `ProductTypeID`, `SKU`, `MODELCODE`, `STATUS`, `slang`, `Product_Info`, `ProductFile`, `ProductBFile`, `ProductSFile`, `Product_Icons`, `Product_dsc`, `Relate_enable`, `Relate_Prod`, `Compat_enable`, `Compat_Prod`, `crea_d`, `crea_u`, `upd_d`, `upd_u`, `Product_Icons_b` FROM `contents_product_skus` where Product_SContents_Auto_ID=".$cid;
	  }
	$prod_result=mysqli_query($link_db,$str_prod);
	$prod_data=mysqli_fetch_row($prod_result);
	$Product_Icons01=$prod_data[21];
	}else{
	$Product_Icons01="";
	}
...
//echo $getIconlist;
echo "<script language='Javascript'>parent.document.forms['form2'].iconvals_b.value='".$getIconlist."';";
