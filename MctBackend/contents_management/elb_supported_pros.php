...
echo "<script language='Javascript'>parent.document.forms['form2'].relProd_val.value='".$tt."';";
...
echo "    parent.window.opener.document.forms['form2'].relProd_val.value = '".$mm_modellist.$mm_skulist.$mb_modellist.$mb_skulist.$chs_skulist.$nh_modellist.$nh_skulist.$as_modellist.$as_skulist.$jbo_modellist.$jbo_skulist.$tpm_modellist.$tpm_skulist.$op_modellist.$op_skulist."'";
echo "  }";
echo "  ";
