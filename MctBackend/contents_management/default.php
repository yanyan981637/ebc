...
<body><a name="top"></a>
    <div>
        <div class="left">
            <h1>&nbsp;&nbsp;Website Backends - Website Contents Management: Products List</h1>
        </div>
    ...
    <div id="Search">
        <div class="left">
            ...
            <select id="SEL_status" name="SEL_status">
                ...
                <option value="1" <?php if ($sel_status == "1") {
                                        echo "selected";
                                    } ?>>Online</option>
                <option value="0" <?php if ($sel_status == "0") {
                                        echo "selected";
                                    } ?>>Offline</option>
            </select> &nbsp;&nbsp;
        ...
        <p class="clear"></p>
        <div id="content">
            <h3 class="left">Products List:</h3>
            <p class="clear"></p>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                ?> </td>
                            <td><? //=substr($slang, 0, strlen($slang)-1);
                                ?></td>
                            <td>
        ...
        <p class="clear">&nbsp;</p>
        <div id="footer"> Copyright &copy; 2013 Company Co. All rights reserved.<div class="gotop" onClick="location='#top'">Top</div>
        </div>
</body>
