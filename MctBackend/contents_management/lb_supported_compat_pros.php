...
$mm_modellist="";$mm_skulist="";$mb_modellist="";$mb_skulist="";$chs_skulist="";$nh_modellist="";$nh_skulist="";$as_modellist="";$as_skulist="";$jbo_skulist="";$tpm_modellist="";$tpm_skulist="";
...
echo "<script language='Javascript'>parent.document.forms['form1'].compacProd_val.value='".$tt."';";
/*echo "<script language='Javascript'>";
echo "try{";
echo "  if(parent.window.opener != null && !parent.window.opener.closed)";
echo "  {";
//echo "    parent.window.opener.document.getElementById('compacProd_val').innerHTML = '".$mm_skulist.$mb_skulist.$chs_skulist.$nh_skulist."'";
//echo "    parent.window.opener.document.getElementById('compacProd_val').value = '".$mm_skulist."'";
echo "    parent.window.opener.document.forms['form1'].compacProd_val.value = '".$mm_modellist.$mb_modellist.$nh_modellist.$as_modellist.$mm_skulist.$mb_skulist.$chs_skulist.$nh_skulist.$as_skulist.$jbo_skulist.$tpm_modellist.$tpm_skulist.$op_modellist.$op_skulist."'";
echo "  }";
echo "  ";
...
<div id="abgne_float_ad" >
		...
		<a href="lb_supported_compat_pros.php#BOTTOM">
