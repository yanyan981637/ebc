...
$strQT="SELECT ID, QT_ID, Company, ToUser, QT_DATE, Due_DATE, Terms, Remarks, Sales, STATUS, Version FROM partner_projects_client WHERE ID='".$QID."'";
				...
				<div class="table-responsive col-sm-12">
					<table class="table">
						...
						<tbody>
							<?php
							$i=0;
							$strItems="SELECT ID, QT_ID, Products, Qty, UnitPrice, Description, Sort, MiTAC_PN FROM partner_projects_items_client WHERE QT_ID='".$QT_ID."' AND Version='".$Version."' ORDER BY Sort ASC";
